                                        ...
                                        $(".tutorial").fadeIn(function(){
                                            ...
                                            document.getElementById("p1").addEventListener('ended',function(){
                                                ...
                                                p2.addEventListener('ended',function(){
                                                    ...
                                                    time_status = 2;
                                                    resource='sounds/get_ready.mp3';
                                                    p3 = new Audio(resource);
                                                    p3.play();
                                                });
                                            });
                                        });
                            ...
                            if(response==999){
                                ...
                                if(response==0){
                                    ...
                                    document.getElementById("draw").addEventListener('ended',function(){
                                        var resource='sounds/restart.mp3';
                                        var restart_ring = new Audio(resource);
                                        restart_ring.play();
